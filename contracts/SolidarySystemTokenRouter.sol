...
/**
 * @title SolidarySystemTokenRouter
 ...
 * @dev Contiene la logica di calcolo per l'equipollenza. È aggiornabile per coerenza architetturale.
 */
contract SolidarySystemTokenRouter is Initializable {
    ...
    function initialize() public initializer {
        // Nessuna variabile di stato da inizializzare, ma la funzione è presente
        // per rispettare il pattern UUPS e la coerenza architetturale.
    }

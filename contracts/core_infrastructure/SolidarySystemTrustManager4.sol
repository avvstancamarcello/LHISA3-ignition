 ...
 */
contract SolidarySystemTrustManager4 is Initializable, OwnableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    function setSolidarySystemMetrics(address _metrics) external onlyOwner {
        solidarySystemMetrics = _metrics;
    }
    ...
    require(solidarySystemMetrics != address(0), "SystemMetrics not set");
    ...
    // Notifica a SolidarySystemMetrics
    (bool notified, ) = solidarySystemMetrics.call(abi.encodeWithSignature(

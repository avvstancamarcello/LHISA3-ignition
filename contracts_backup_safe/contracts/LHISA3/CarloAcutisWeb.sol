...
contract CarloAcutisWeb is ERC1155, Ownable {
    uint256 public constant PAGE_OF_FAITH = 1;

    constructor(address initialOwner) ERC1155("https://solidary.it/api/carloacutis/{id}.json") Ownable(initialOwner) {}

    function mint(address to, uint256 amount) public onlyOwner {
        _mint(to, PAGE_OF_FAITH, amount, "");
    }

 ...
 */
contract LunaComicsAdvancedSwapper is OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    uint256 public conversionFeeBps = 30; // 0.30% default fee
